...
<div class="span14">
		...
		<ul>
    	 ...
    	 foreach($urls as $key => $value) {
    	 	if($value!='') {
    	 		...
    	 		if(is_string($value)) 
    	 			{
    	 			?><li><a href="<?php echo $value;?>" target="_blank"><?php echo $key;?></a></li><?php 
    	 			}
    	 		}
    	 	}
	     ?>
    ...
    if(isset($search->locations[0]->editorials) && count($search->locations[0]->editorials) > 0) {
	    ...
	    foreach($editorials as $editorial) {
		 	...
		 	?><li><a href="<?php echo $editorial_url;?>"><strong><?php echo $editorial_title; ?></strong></a> = <?php echo $editorial_review; ?></li><?
	     	}
	     ?>
	     </ul>
	     <?php
    ...
    if(isset($search->locations[0]->review_info) && count($search->locations[0]->review_info) > 1) {
	    ...
	    foreach($reviews as $review) {
		 	...
		 	?><li><a href="<?php echo $review_url;?>"><strong><?php echo $review_title; ?></strong></a> = <?php echo $review_text; ?></li><?
	     	}
	     ?>
	     </ul>
	     <?php
